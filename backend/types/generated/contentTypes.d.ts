...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    imagenDestacada: Schema.Attribute.Media<
...
export interface ApiGeneroGenero extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    videojuegos: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiVideojuegoVideojuego extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    desarrolladora: Schema.Attribute.String;
    descripcionCompleta: Schema.Attribute.RichText;
    descripcionCorta: Schema.Attribute.String & Schema.Attribute.Required;
    destacado: Schema.Attribute.Boolean;
    fechaLanzamiento: Schema.Attribute.Date;
    ...
    metaDescription: Schema.Attribute.Text;
    metaTitle: Schema.Attribute.String;
    plataformas: Schema.Attribute.Relation<
      'manyToMany',
      'api::plataforma.plataforma'
    >;
    publishedAt: Schema.Attribute.DateTime;
